...
import { getVendorInfo } from "../../redux/action/vendor";
...
const EditVendor = () => {
  ...
  console.log("This is the ",venderInfo)

  const initialValues = {
    name: venderInfo?.name || "",
    description: venderInfo?.description || "",
    vendorList: venderInfo?.vendorList || [
      {
        vendorName: "",
        varient: "",
        number: "",
  ...
  const handleSubmit = (values, { setSubmitting }) => {
    try {
    //   dispatch(editVendor(params.id, values));
      console.log(values);
    } catch (error) {
  ...
  if (!venderInfo) {
    return <div>No vendor information available.</div>;
  }
...
export default DashboardLayout(EditVendor);
